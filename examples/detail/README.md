...
For background/metadata stream context, cross-reference `../../docs/metadata_background_quickstart.md` which explains how the detail demos fan out `DataEvent` and `MetaEvent` streams.
