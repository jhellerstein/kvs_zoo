...
//!
//! ```ignore
//! // Region → Datacenter → Rack → Node
//! KVSCluster {
//!     dispatch: RegionRouter::new(3),         // Route to region by key
//!     maintenance: ZeroMaintenance,           // No cross-region sync
//!     count: 3,                               // 3 regions
//!     each: KVSCluster {
//!         dispatch: DatacenterRouter::new(),  // Route to datacenter
//!         maintenance: SimpleGossip::new(100),  // Gossip between datacenters
//!         count: 2,                           // 2 datacenters per region
//!         each: KVSNode {
//!             dispatch: (),                   // No routing at leaf
//!             maintenance: TombstoneCleanup::new(5000),  // Local cleanup
//!             count: 5                        // 5 nodes per datacenter
//!         }
//!     }
//! }
//! // Total: 3 regions × 2 datacenters × 5 nodes = 30 nodes
//! ```
