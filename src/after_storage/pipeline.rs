...
//! We keep re-exports so existing impl paths like `pipeline::MaintenanceReplicator` still compile.

// Re-export maintenance metadata traits for compatibility during transition.
pub use crate::after_storage::meta::{
    MaintenanceLocalHandler, MaintenanceMsg, MaintenanceReplicator,
};
