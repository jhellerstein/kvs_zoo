...
pub trait KVSShardable<V> {
    ...
    type StorageType: Clone + std::fmt::Debug + serde::Serialize + serde::de::DeserializeOwned + Send + Sync + 'static;

    /// Put key-value pairs and return the KVS state
    fn put<'a>(
        put_tuples: hydro_lang::prelude::Stream<(String, V), hydro_lang::prelude::Cluster<'a, crate::core::KVSNode>, hydro_lang::prelude::Unbounded>,
        cluster: &hydro_lang::prelude::Cluster<'a, crate::core::KVSNode>,
    ) -> hydro_lang::prelude::KeyedSingleton<String, Self::StorageType, hydro_lang::prelude::Cluster<'a, crate::core::KVSNode>, hydro_lang::prelude::Unbounded>
    where
        V: Clone + std::fmt::Debug + serde::Serialize + serde::de::DeserializeOwned + Send + Sync + 'static;

    /// Get values for keys from the KVS state
    fn get<'a>(
        get_keys: hydro_lang::prelude::Stream<String, hydro_lang::prelude::Tick<hydro_lang::prelude::Cluster<'a, crate::core::KVSNode>>, hydro_lang::prelude::Bounded>,
        kvs_state: hydro_lang::prelude::KeyedSingleton<String, Self::StorageType, hydro_lang::prelude::Tick<hydro_lang::prelude::Cluster<'a, crate::core::KVSNode>>, hydro_lang::prelude::Bounded>,
...
where
    V: Clone + Default + PartialEq + Eq + std::fmt::Debug + serde::Serialize + serde::de::DeserializeOwned + Send + Sync + 'static,
{
...
where
    V: Clone + Default + PartialEq + Eq + Merge<V> + std::fmt::Debug + serde::Serialize + serde::de::DeserializeOwned + Send + Sync + 'static,
