//! Pinned Router Operation Interceptor
//!
//! The PinnedRouter is intended for usage over a single node and acts as a
...
/// PinnedRouter sends every operation to a single node (member 0).
///
...
///
/// ```rust
/// use kvs_zoo::interception::routing::PinnedRouter;
/// use kvs_zoo::interception::OpIntercept;
///
/// let router = PinnedRouter::new();
...
impl PinnedRouter {
    /// Create a new pinned router
    pub fn new() -> Self {
        Self
    }
}

impl<V> OpIntercept<V> for PinnedRouter {
