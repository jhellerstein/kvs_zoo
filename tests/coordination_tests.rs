...
/// Paxos provides TotalOrder directly to the target cluster. Each member
/// processes with scan. No separate routing or replication layer needed —
/// Paxos broadcast already delivers to all members.
#[test]
